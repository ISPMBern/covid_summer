...
noimport_model_output <- readRDS("sensitivity01_noimport_model_output2020_2022-03-17.rds")
noimport_model_output <- readRDS("sensitivity1_noimport_model_output2020_2022-03-17.rds")
...
imports_d$abroad15_weighted <- round(cases_su$cases_abroad*1.5*weighting)
imports_d$abroad1_15_weighted <- round(cases_su$cases_abroad*0.5*weighting)
...
saveRDS(model_outputs, paste0("import_model_output2020_1_",z,"_",Sys.Date(),".rds"))
