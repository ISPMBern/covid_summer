...
%Thus, the seen increased incidence was only possible due to new introductions, i.e., cross-border-associated cases.
...
%This simplification was acceptable as we found hardly evidence that residence was associated with cross-border-associated cases (Supplementary Figure \ref{sf3}).
...
% rather present confirmed prevalence per 10^5?
...
%Overall, the age group between 21 and 64 years had the highest incidence in summer 2020.
...
%Highlighting the importance of implementing and following up studies like Co-Mix.
