...
%\usepackage[backend=biber]{biblatex} % I changed the citation approach I think it is easier that way, feel free to revert back if you prefer
\usepackage{graphicx}
\usepackage{newfloat}
\usepackage{hyperref}
...
%\addbibresource{su2020_cov2.bib} % this is now at the end
...
% Julien: This first paragraph needs more work. Especially it is too heavily based on Russel. Maybe a short review of the litterature on importation would help writing a good background? A good starting point: https://www.eurosurveillance.org/content/10.2807/1560-7917.ES.2020.25.4.2000057/?crawler=true
...
% Julien: The old definition based on susceptible and non-susceptible missed the effect of control measures, behaviour and the time component.
...
% Julien: is it 2.8 or 7.8? Both appear in the text
...
% Julien: so you computed the effective growth rate on the simulated data?
...
% Julien: this needs improvement, I don't know if it's older or younger for instance. Also avoid the term 'significant' if there isn't a test.
...
% Julien: I don't see the point of that, why would imports not transmit?
...
% Julien: That's not really a result, is it?
