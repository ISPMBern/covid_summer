...
% Julien: I didn't understand the following sentences, I tried to reformulate
...
%From these simulated cases per day, we made range of the minimum and maximum number of potential cases per day, i.e., 12 cases to 33 cases per day. 
...
%Julien: is it what you mean? I don't get how you got these numbers, if I extrapolate over the people with missing country I find 6347, then multiplied by 2/3 it's 5350 and by 3/2 it's 7844
%tot = 23199
%cro = 3354
%mis = 10940
%
...
%cro/(tot-mis)
%cro + cro/(tot-mis)*mis
%cro + cro/(tot-mis)*mis*2/3
%cro + cro/(tot-mis)*mis*3/2



\begin{table*}
	\caption{Prior distributions of the parameters used to simulate the epidemic trajectories.}% *Normal distribution with a mean of 0.51. **3,304 reported cross-border-associated cases were weighted due to missing data and multiplied with 0, 2/3, 1, and 1.5. ***The SFOPH reported 23,199 cases for the period from June to September 2020.\\}\ 
	\label{t1}
\begin{tabular}{clll}
	\hline
...
Following the principles of approximate Bayesian computation (ABC), simulated epidemic trajectories were rejected when the cumulative incidence and final incidence fell outside of a predefined range.%(Figure \ref{f2}a,b). 
% Julien: Figure 2ab doesn't help here 
...
% Julien: is that what you did?

%using $10^4$ simulations of random negative binomial models, where the size was derived from the standard error of the model of reported SARS-CoV-2 cases and a $\mu$ of reported cases.
